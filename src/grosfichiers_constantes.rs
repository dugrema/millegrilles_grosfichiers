...
pub const NOM_COLLECTION_FILE_COMMENTS: &str = "GrosFichiers/fileComments";
...
pub const EVENT_FILES_TO_INDEX: &str = "filesToIndex";
...
pub const CHAMP_FLAG_SUMMARY: &str = "flag_summary";
